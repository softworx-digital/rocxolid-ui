...
export default function (target) {
    ...
    if (target.is(`.${CSS_CLASS.COMPONENT}`)) {
        ...
        showSettingForm.call(self, target, componentType, SETTING_CATEGORY.COMPONENT, componentData.settingTitle(self, target), componentData.initSettingForm, componentData.showSettingForm, componentData);
